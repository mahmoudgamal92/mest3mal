            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <div class="col-md-12">
                        ...
                        <?php echo Form::open(['files'=>true,'url'=>AdminPath().'/department/'.$edit->id,'method'=>'put','class'=>'form-horizontal form-row-seperated']); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            <button type="submit" class="btn blue"><?php echo e(trans('orbscope.edit')); ?> <?php echo e(trans('orbscope.department')); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
