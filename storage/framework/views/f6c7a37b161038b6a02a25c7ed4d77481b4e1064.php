<div class="col-lg-3 col-md-3 account-sidebar">
    <div class="account-bio d-flex">
        <img class="acc-avatar-bio" src="<?php echo e(ShowImage(auth()->user()->image)); ?>">
        <div class="account-info-wrap">
            <div class="account-info">
                <span class="account-name"><?php echo e(auth()->user()->name); ?></span>
                <!--
                <span class="account-verified"><img src="img/tick-icon.png"></span>-->
                <span class="account-date">تاريخ التسجيل <?php echo e(auth()->user()->created_at->diffForHumans()); ?></span>
            </div>
        </div>
    </div> <!-- end account-bio -->
    <div class="account-links">
        <ul>
            <li <?php if(url()->current()==url('user/profile')): ?> style="background-color: #34ACE0;" <?php endif; ?>>
                <a href="<?php echo e(url('user/profile')); ?>">
                    ...
                    <?php echo e(trans('orbscope.profile')); ?></a></li>
            <li>
                <a href="<?php echo e(url('/user/chat')); ?>">
                    ...
                    <?php echo e(trans('front.messages')); ?></a></li>
            <!--
            <li>
                <a href="account-notifications.html">
                    ...
                    <?php echo e(trans('front.notfications')); ?></a></li>-->

            <li <?php if(url()->current()==url('user/all_ads')): ?> style="background-color: #34ACE0;" <?php endif; ?>>
                <a href="<?php echo e(url('/user/all_ads')); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="15.234" viewBox="0 0 20 15.234">
                        <g id="interface_21_" data-name="interface (21)" transform="translate(0 -61)">
                            <g id="Group_584" data-name="Group 584" transform="translate(0 61)">
                                <path id="Path_2473" data-name="Path 2473" d="M18.242,61H1.758A1.761,1.761,0,0,0,0,62.758V74.477a1.761,1.761,0,0,0,1.758,1.758H18.242A1.761,1.761,0,0,0,20,74.477V62.758A1.761,1.761,0,0,0,18.242,61ZM18,62.172l-7.962,7.962L2.006,62.172ZM1.172,74.234V62.995l5.644,5.6ZM2,75.063l5.647-5.647,1.979,1.962a.586.586,0,0,0,.827,0l1.929-1.929L18,75.063Zm16.828-.829-5.617-5.617L18.828,63Z" transform="translate(0 -61)" fill="#2e2e2e" opacity="0.8"/>
                    ...
                    <?php echo e(trans('front.My_Ads')); ?></a>
            </li>

            <li <?php if(url()->current()==url('user/all_auctions')): ?> style="background-color: #34ACE0;" <?php endif; ?>>
                <a href="<?php echo e(url('/user/all_auctions')); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="15.234" viewBox="0 0 20 15.234">
                        <g id="interface_21_" data-name="interface (21)" transform="translate(0 -61)">
                            <g id="Group_584" data-name="Group 584" transform="translate(0 61)">
                                <path id="Path_2473" data-name="Path 2473" d="M18.242,61H1.758A1.761,1.761,0,0,0,0,62.758V74.477a1.761,1.761,0,0,0,1.758,1.758H18.242A1.761,1.761,0,0,0,20,74.477V62.758A1.761,1.761,0,0,0,18.242,61ZM18,62.172l-7.962,7.962L2.006,62.172ZM1.172,74.234V62.995l5.644,5.6ZM2,75.063l5.647-5.647,1.979,1.962a.586.586,0,0,0,.827,0l1.929-1.929L18,75.063Zm16.828-.829-5.617-5.617L18.828,63Z" transform="translate(0 -61)" fill="#2e2e2e" opacity="0.8"/>
                    ...
                    <?php echo e(trans('front.Auctions')); ?></a>
            </li>


            <li <?php if(url()->current()==url('user/orders')): ?> style="background-color: #34ACE0;" <?php endif; ?>>
                ...
                <a href="<?php echo e(url('/user/orders')); ?>">
                    ...
                    <?php echo e(trans('front.my_orders')); ?></a></li>

            <li <?php if(url()->current()==url('user/favorite_ads')): ?> style="background-color: #34ACE0;" <?php endif; ?>>
                <a  href="<?php echo e(url('/user/favorite_ads')); ?>">
                    ...
                    <?php echo e(trans('front.Favorite_ads')); ?></a>
            </li>

            <li <?php if(url()->current()==url('user/wallet')): ?> style="background-color: #34ACE0;" <?php endif; ?>>


                <a href="<?php echo e(url('user/wallet')); ?>">
                    ...
                    <?php echo e(trans('front.my_wallet')); ?></a></li></li>
        </ul>
    </div>
</div>