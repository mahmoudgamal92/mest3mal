...
<?php $__env->startSection('content'); ?>
    ...
    <div class="main-section bg-main post-add-bg">
        <div class="container container-post-add">
            <form method="post" action="<?php echo e(url('user/store/auction')); ?>"  enctype="multipart/form-data">
                <?php echo e(csrf_field()); ?>


                <div class="custom-bg-pd mb-3 post-detail-wrap post-ads-content">
                    <h3 class="add-post-title"><?php echo e(trans('orbscope.add')); ?> <?php echo e(trans('front.auction')); ?></h3>
                    <div class="post-detail-fields row">
                        ...
                        <div class="form-group col-12 form-control-004">
                            ...
                            <input type="text" value="<?php echo e(old('title')); ?>" name="title" required class="form-control form-control-123" id="AdTitle" placeholder="<?php echo e(trans('front.auction_title')); ?>">
                        </div> <!-- title /-->
                        <div class="form-group col-12 form-control-004">
                            <label for="addescription" class="field-heading"><?php echo e(trans('orbscope.details')); ?> </label>
                            <textarea class="form-control form-control-123" required name="details" id="addescription" placeholder="<?php echo e(trans('front.product_details')); ?>" rows="3"><?php echo e(old('details')); ?></textarea>
                        </div> <!-- title /-->
                        ...
                        <div class="form-group col-lg-12 form-group-123">
                            ...
                            <div class="form-group categori d-flex">
                                <select  required  name="duration" class="form-control">
                                    ...
                                    <?php for($x=1;$x<8;$x++): ?>
                                        <option <?php echo e(old('duration')==$x?'selected':''); ?> value="<?php echo e($x); ?>"><?php echo e($x); ?></option>
                                    <?php endfor; ?>
                                </select>
                            </div>
                        </div> <!-- Price /-->
                        ...
                        <div class="form-group col-lg-4 form-group-123">
                            <div class="form-group categori">
                                ...
                                <input type="text" required value="<?php echo e(old('address')); ?>" name="address" class="form-control form-control-123" id="AdTitle" placeholder="">
                            </div>
                        </div> <!-- address /-->
                ...
                <div class="custom-bg-pd mb-3 text-center post-ads-content">
                    <h3 class="add-post-title"><?php echo e(trans('front.ready_for_publish')); ?></h3>
                    <button type="submit" class="btn custom-btn published-by-ads"><?php echo e(trans('front.publich_auction')); ?></button>
                </div> <!--publish /-->
            </form>
        </div>
    </div>
