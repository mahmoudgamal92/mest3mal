        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="<?php echo e(url(AdminPath().'/cities/create')); ?>"
                           data-toggle="tooltip" title="<?php echo e(trans('orbscope.add')); ?>  <?php echo e(trans('orbscope.cities')); ?>">
                            <i class="fa fa-plus"></i>
                        </a>
                        <a class="btn btn-circle btn-icon-only btn-default" href="<?php echo e(url(AdminPath().'/cities/'.$show->id.'/edit')); ?>"
                           data-toggle="tooltip" title="<?php echo e(trans('orbscope.edit')); ?>  <?php echo e(trans('orbscope.cities')); ?>">
                            <i class="fa fa-edit"></i>
                        </a>

                        <span data-toggle="tooltip" title="<?php echo e(trans('orbscope.delete')); ?>  <?php echo e(trans('orbscope.cities')); ?>">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <strong><?php echo e(trans('orbscope.country')); ?> : </strong>
                                    <?php echo e(VarByLang($show->city_country->name,GetLanguage())); ?>
