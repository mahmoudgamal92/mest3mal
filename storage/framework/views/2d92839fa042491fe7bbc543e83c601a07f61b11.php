...
<?php $__env->startSection('content'); ?>
    ...
    <div class="main-section bg-main post-add-bg">
        <div class="container container-post-add">
            <form method="post" action="<?php echo e(url('user/store/car_ads')); ?>"  enctype="multipart/form-data">
                ...
                <div class="custom-bg-pd mb-3 post-detail-wrap post-ads-content">
                    ...
                    <div class="post-detail-fields row">
                        ...
                        <div class="form-group col-12 form-control-004">
                            ...
                            <input type="text" value="<?php echo e(old('title')); ?>" name="title" required class="form-control form-control-123" id="AdTitle" placeholder="اكتب العنوان هنا">
                        </div> <!-- title /-->
                        <div class="form-group col-12 form-control-004">
                        ...
                        <div class="form-group col-lg-4 form-group-123">
                            <div class="form-group categori">
                                ...
                                <input type="url" value="<?php echo e(old('address')); ?>" required class="form-control form-control-123" name="address" id="AdTitle" placeholder="">
                            </div>
                        </div> <!-- address /-->
