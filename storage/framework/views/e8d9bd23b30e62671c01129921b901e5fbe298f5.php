            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <div class="col-md-12">
                        ...
                        <?php echo Form::open(['files'=>true,'route'=>'countries.store','class'=>'form-horizontal form-row-seperated']); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <?php echo Form::label('flag',trans('orbscope.flag'),['class'=>'col-md-3 control-label','for'=>'flag']); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            <button type="submit" class="btn blue"><?php echo e(trans('orbscope.add')); ?> <?php echo e(trans('orbscope.country')); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
