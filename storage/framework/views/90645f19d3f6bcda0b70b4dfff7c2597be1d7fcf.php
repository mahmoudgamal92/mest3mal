        ...
        <div class="container container-post-add">
            ...
            <div class="col-md-8 category-wrapper custom-bg-nobd">
                <ul class="cat-nav mb-0 nav nav-tabs d-block border-0">
                    <?php $__currentLoopData = $sub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $depart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="nav-item">
                            <a href="<?php echo e(url('user/sub_cat/select/'.$depart->id)); ?>" class="d-block position-relative" >
