...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="<?php echo e(url(AdminPath().'/sub_category')); ?>"
                           data-toggle="tooltip" title="<?php echo e(trans('orbscope.show-all')); ?>   <?php echo e(trans('sub_category')); ?>">
                ...
                <div class="portlet-body form">
                    <div class="col-md-12">
                        ...
                        <?php echo Form::open(['files'=>true,'url'=>AdminPath().'/sub_category/'.$edit->id,'method'=>'put','class'=>'form-horizontal form-row-seperated']); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group<?php echo e($errors->has('en_name') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-9">
                                    <?php echo Form::text('en_name',VarByLang($edit->name,'en'),['class'=>'form-control','id'=>'en_name','placeholder'=>trans('orbscope.en-name'),'required']); ?>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="show_website"><?php echo e(trans('orbscope.status')); ?></label>
                                <div class="col-md-9">
                                    <input type="hidden" name="status" id="status" value="inactive">
                                    <input type="checkbox" name="status" id="status" class="make-switch" data-on-text="<?php echo e(trans('orbscope.show')); ?>" data-off-text="<?php echo e(trans('orbscope.hide')); ?>" value="active"  <?php if($edit->status == 'active'): ?> checked <?php endif; ?>>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-3 control-label"><?php echo e(trans('orbscope.shop')); ?> <span class="required" aria-required="true"> * </span> </label>
                                <div class="col-md-9">

                                    <select name="shop_id"  id="shop_id" class="form-control select2" data-placeholder="<?php echo e(trans('orbscope.shop')); ?>" required>
                                        <option></option>
                                        <?php $__currentLoopData = $shop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cont): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($cont->id); ?>" <?php if($cont->id == $edit->depart_id): ?> selected <?php endif; ?>><?php echo e(VarByLang($cont->name,GetLanguage())); ?></option>
                            ...
                            <label class="col-md-3 control-label"><?php echo e(trans('orbscope.category')); ?> <span class="required" aria-required="true"> * </span> </label>
                            <div class="col-md-9">
                                <select class="form-control select2" data-placeholder="<?php echo e(trans('orbscope.category')); ?>" id="cat_id" name="cat_id" required>
                                    <option></option>
                                    <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($city->id); ?>" <?php if($city->id == $edit->cat_id): ?> selected <?php endif; ?>><?php echo e(VarByLang($city->name,GetLanguage())); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            </div>
                                ...
                                <div class="col-md-9">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            <img src="<?php echo e(ShowImage($edit->image)); ?>" />
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            <button type="submit" class="btn blue"><?php echo e(trans('orbscope.edit')); ?> <?php echo e(trans('orbscope.sub_category')); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(document).on('change', '#shop_id', function () {
            ...
            $.ajax({
                url: '<?php echo e(url(AdminPath().'/subcategory/ajax')); ?>',
                dataType: 'html',
                type: 'post',
