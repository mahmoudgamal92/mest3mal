...
<?php $__env->startSection('content'); ?>
    ...
    <script src="<?php echo e(url('orbscope/admin')); ?>/assets/pages/scripts/components-select2.js" type="text/javascript"></script>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <div class="col-md-12">
                        <?php echo Form::open(['files'=>true,'route'=>'cities.store','class'=>'form-horizontal form-row-seperated']); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group<?php echo e($errors->has('country_id') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-9">
                                    <select name="country_id" id="country" class="form-control country_id select2" data-placeholder="<?php echo e(trans('orbscope.country')); ?>" required>
                                        <option></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <input type="checkbox" name="show_website" id="show_website" class="make-switch" data-on-text="<?php echo e(trans('orbscope.show')); ?>" data-off-text="<?php echo e(trans('orbscope.hide')); ?>" value="show" >
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            <button type="submit" class="btn blue"><?php echo e(trans('orbscope.add')); ?> <?php echo e(trans('orbscope.cities')); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
