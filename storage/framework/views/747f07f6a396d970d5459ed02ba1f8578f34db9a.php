                        ...
                        <div class="modelcontent">
                            <div class="col-12 p-0">
                                <div class="menu_cate_list popover-custom">
                                    <ul>
                                        <?php $__currentLoopData = \App\Orbscope\Models\Department::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $de): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading" style="text-align: <?php echo e(GetLanguage()=='ar'?'right':''); ?>"><?php echo e(trans('orbscope.rest_pass')); ?></div>

                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('reset-password')); ?>">
                        <?php echo e(csrf_field()); ?>
                        ...
                        <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                            <label for="email" class="col-md-4 control-label"><?php echo e(trans('orbscope.email')); ?></label>
                        ...
                        <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                            <label for="password" class="col-md-4 control-label"><?php echo e(trans('orbscope.password')); ?></label>
                        ...
                        <div class="form-group<?php echo e($errors->has('password_confirmation') ? ' has-error' : ''); ?>">
                            <label for="password-confirm" class="col-md-4 control-label"><?php echo e(trans('orbscope.password_confirmation')); ?></label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-refresh"></i> <?php echo e(trans('orbscope.save')); ?>
