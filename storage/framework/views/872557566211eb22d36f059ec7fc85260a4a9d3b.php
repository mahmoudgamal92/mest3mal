...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    <?php echo Form::open(['method' => 'post','url' => [AdminPath().'/services/multi_delete']]); ?>

                    <?php echo $dataTable->table(['class'=> 'table table-striped table-bordered table-hover']); ?>
    ...
    <script>
        ...
        $(document).on('click', '.uploadBtn', function() {
            window.location = "services/upload";
        });
