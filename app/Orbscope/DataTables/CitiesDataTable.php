...
class CitiesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables($query)->setRowId('id')
            ...
            ->addColumn('city_country','admin.cities.buttons.country')
            ->addColumn('checkbox','<input type="checkbox" class="selected_data" name="selected_data[]" value="{{ $id }}">')
            ->addColumn('show','admin.cities.buttons.show')
    ...
    {
        $query = City::query()->with('city_country')->select('cities.*');
        ...
        $html =  $this->builder()
            ...
            ->parameters([
                ...
                'buttons' => [
                    ...
                    [
                        'text' => '<i class="fa fa-upload"></i> '.trans('orbscope.upload-file'),
                        'className' => 'btn  default uploadBtn'
                    ],
