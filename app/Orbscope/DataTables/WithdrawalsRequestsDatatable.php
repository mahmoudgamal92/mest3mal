...
class WithdrawalsRequestsDatatable extends DataTable

{
    ...
    public function query()
    {
        ...
        $query = Withdrawal::query()->where('status', $this->lead_id)->with('user')->select('withdrawals.*');
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name' => 'created_at',
                'data' => 'created_at',
                'title' => trans('orbscope.date').' '.trans('orbscope.order'),
                'searchable' => true,
                'orderable'  => true,
            ],
        ];
