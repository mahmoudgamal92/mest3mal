            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <div class="col-md-12">
                        ...
                        {!! Form::open(['files'=>true,'url'=>AdminPath().'/countries/'.$edit->id,'method'=>'put','class'=>'form-horizontal form-row-seperated']) !!}
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <input type="checkbox" name="show_website" id="show_website" class="make-switch" data-on-text="{{trans('orbscope.show')}}" data-off-text="{{trans('orbscope.hide')}}" value="show"  @if($edit->show_website == 'show') checked @endif>
                                </div>
                                </div>

                            <div class="form-group">
                                {!! Form::label('flag',trans('orbscope.flag'),['class'=>'col-md-3 control-label','for'=>'flag']) !!}
                                <div class="col-md-9">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            <img src="{{ShowImage($edit->flag)}}" />
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            <button type="submit" class="btn blue">{{trans('orbscope.edit')}} {{trans('orbscope.country')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
