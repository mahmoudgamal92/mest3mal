        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{url(AdminPath().'/pages/create')}}"
                           data-toggle="tooltip" title="{{trans('orbscope.add')}}  {{trans('orbscope.pages')}}">
                        ...
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{url(AdminPath().'/pages')}}"
                           data-toggle="tooltip" title="{{trans('orbscope.show-all')}}   {{trans('orbscope.pages')}}">
                ...
                <ul class="nav nav-tabs nav-tabs-lg">
                    <li @if(url(AdminPath().'/pages/'.$show->id) == URL::current()) class="active" @endif>
                        <a href="{{url(AdminPath().'/pages/'.$show->id)}}" >{{trans('orbscope.pages_information')}}</a>
                    </li>

                    <li @if(url(AdminPath().'/pages/'.$show->id.'/sub_pages') == URL::current()) class="active" @endif>
                        <a href="{{url(AdminPath().'/pages/'.$show->id.'/sub_pages')}}" >{{trans('orbscope.sub_pages')}}  <i class="fa fa-server"></i></a>
                    </li>

                    <li @if(url(AdminPath().'/pages/'.$show->id.'/product') == URL::current()) class="active" @endif>
                        <a href="{{url(AdminPath().'/pages/'.$show->id.'/product')}}" >{{trans('orbscope.product')}}  <i class="fa fa-archive"></i></a>
                    </li>
