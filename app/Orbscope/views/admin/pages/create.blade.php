                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group{{ $errors->has('ar_description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-5">
                                    {!! Form::textarea('ar_description',old('ar_description'),['class'=>'form-control','placeholder'=>trans('orbscope.ar_description'),'rows'=>'3']) !!}
                                </div>
                                <div class="col-md-5">
                                    {!! Form::textarea('en_description',old('en_description'),['class'=>'form-control','placeholder'=>trans('orbscope.en_description'),'rows'=>'3']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <span class="btn default btn-file">
                                         ...
                                         <input type="file" name="image" id="flag" accept=".image/jpeg,.png,.jpg,.bmp,.gif,.svg">
                                    </span>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            <button type="submit" class="btn blue">{{trans('orbscope.add')}} {{trans('orbscope.pages')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
