        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <div class="col-md-12">
                        {!! Form::model($permission,['route'=>['permissions.update', $permission->id],'method'=>'PUT','class'=>'form-horizontal form-row-seperated']) !!}
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="name">{{trans('orbscope.permision_name')}}</label>
                                <div class="col-md-9">
                                    {!! Form::text('name',null,['class'=>'form-control','placeholder'=>trans('orbscope.permision_name')]) !!}
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                <button type="submit" class="btn blue">{{trans('orbscope.edit')}} {{trans('orbscope.permissions')}}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
