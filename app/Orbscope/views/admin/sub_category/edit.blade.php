                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="show_website">{{trans('orbscope.status')}}</label>
                                <div class="col-md-9">
                                    <input type="hidden" name="status" id="status" value="inactive">
                                    <input type="checkbox" name="status" id="status" class="make-switch" data-on-text="{{trans('orbscope.show')}}" data-off-text="{{trans('orbscope.hide')}}" value="active"  @if($edit->status == 'active') checked @endif>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select name="shop_id"  id="shop_id" class="form-control select2" data-placeholder="{{trans('orbscope.shop')}}" required>
                                        <option></option>
                                        @foreach($shop as $cont)
                                            <option value="{{$cont->id}}" @if($cont->id == $edit->depart_id) selected @endif>{{VarByLang($cont->name,GetLanguage())}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-9">
                                <select class="form-control select2" data-placeholder="{{trans('orbscope.category')}}" id="cat_id" name="cat_id" required>
                                    ...
                                    @foreach($category as $city)
                                        <option value="{{$city->id}}" @if($city->id == $edit->cat_id) selected @endif>{{VarByLang($city->name,GetLanguage())}}</option>
                                    @endforeach
                                </select>
                            </div>
                            </div>
