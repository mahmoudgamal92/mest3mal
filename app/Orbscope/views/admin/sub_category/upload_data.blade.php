                ...
                <div class="portlet-body">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="alert alert-block alert-info fade in text-center">
                            ...
                            <p> -  {{trans('orbscope.upload_inwebsite')}}</p>
                            <p> -  {{trans('orbscope.upload_status')}}</p>
                        </div>
                    </div>
                    <form action="{{ URL::to(AdminPath().'/sub_category/upload/saveExcel') }}" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="feilds[]" class="form-control select2" data-placeholder="{{trans('orbscope.orb_fields')}}" required>
                                                ...
                                                <option value="image">{{trans('orbscope.image')}} </option>
                                                <option value="description">{{trans('orbscope.description')}} </option>
                                                <option value="status">{{trans('orbscope.status')}} </option>
                                                <option value="show_website">{{trans('orbscope.show_website')}} </option>
                                            </select>
                                        </td>
                                    </tr>
                                @endfor
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        <button type="submit" class="btn blue">{{trans('orbscope.upload')}} {{trans('orbscope.sub_category')}}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
