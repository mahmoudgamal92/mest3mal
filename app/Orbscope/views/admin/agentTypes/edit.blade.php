            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <div class="col-md-12">
                        ...
                        {!! Form::open(['files'=>true,'url'=>AdminPath().'/agentTypes/'.$edit->id,'method'=>'put','class'=>'form-horizontal form-row-seperated']) !!}
                        <div class="row">
                            ...
                            <div class="form-group {{ $errors->has('ar_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('ar_name',VarByLang($edit->name,'ar'),['class'=>'form-control','placeholder'=>trans('orbscope.ar-name')]) !!}
                            ...
                            <div class="form-group {{ $errors->has('en_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('en_name',VarByLang($edit->name,'en'),['class'=>'form-control','placeholder'=>trans('orbscope.en-name')]) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    {!! Form::textarea('description',$edit->description,['class'=>'form-control','id'=>'description','placeholder'=>trans('orbscope.description')]) !!}
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                <button type="submit" class="btn blue">{{trans('orbscope.edit')}} {{trans('orbscope.agentTypes')}}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
