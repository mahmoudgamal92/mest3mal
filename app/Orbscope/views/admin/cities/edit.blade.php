                        ...
                        <div class="row">
                            ...
                            <div class="form-group{{ $errors->has('country_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select name="country_id" class="form-control country_id select2" data-placeholder="{{trans('orbscope.country')}}" required>
                                        <option></option>
                                        @foreach($country as $cont)
                                            <option value="{{$cont->id}}" @if($cont->id == $edit->country_id) selected @endif>{{VarByLang($cont->name,GetLanguage())}}</option>
                                            @endforeach
                                        </select>
