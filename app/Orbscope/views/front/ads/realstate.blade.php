                    ...
                    <div class="post-detail-fields row">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="row m-0">
                                @foreach(\App\Orbscope\Models\Service::where('status','active')->get() as $key=>$se)
                                    <div class="form-check col-sm-6 col-12 custom-check">
                                        <input class="form-check-input" name="service[]" type="checkbox"  value="{{$se->id}}" id="{{$key}}servies">
                        ...
                        <div class="form-group col-lg-4 form-group-123">
                            <div class="form-group categori">
                                ...
                                <input type="url" value="{{old('address')}}" required name="address" class="form-control form-control-123" id="AdTitle" placeholder="">
                            </div>
                        </div> <!-- address /-->
